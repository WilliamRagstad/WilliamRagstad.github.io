...
<command- for="#more-notation" toc-collapse></command->
<command- for="#more-notation:parent" center></command->
...
<command- for="#properties" toc-collapse></command->
<command- for="#properties:parent" center></command->
